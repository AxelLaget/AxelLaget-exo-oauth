 ...
 */
	res.redirect(`http://oauth-authorizationserver.cluster-ig5.igpolytech.fr/authorize?response_type=code&scope=foo&client_id=${client.client_id}&redirect_uri=${client.redirect_uris[0]}`)
})
